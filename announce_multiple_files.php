...
define('__LOCATION_PEERS', 'Torrents-Files' . '/' . $info_hash . '.torrents-files');
...
$log_dir = 'Torrents-Tracker-Logs';
if (!is_dir($log_dir)) {
    mkdir($log_dir, 0777, true);
}

define('__LOG_FILE', $log_dir . '/' . 'error.log');
